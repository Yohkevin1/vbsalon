            ...
            <div class="card-body">
                <div class="row mb-3">
                    ...
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <input class="form-control" type="text" id="nama" value="" disabled>
                        <input class="form-control" type="hidden" id="no_pegawai" value="">
                    </div>
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <label class="col-form-label">Telp Pelanggan:</label>
                        <input type="text" id="telp_pel" class="form-control" value="{{$pjl->telp_pelanggan}}" disabled>
                    </div>
                </div>
                <div class="row mb-3">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6 col-md-6 col-sm-12">
                        <div class="mb-3 row">
                            ...
                            <div class="col-8">
                                <input type="text" class="form-control" id="nominal" value="{{ old('bayar', $pjl->bayar) }}" autocomplete="off">
                            </div>
                        </div>
                        <div class="mb-3 row">
