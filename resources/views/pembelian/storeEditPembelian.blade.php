...
<div class="row" style="color: black">
    <div class="col-md-12">
        <div class="card mb-4">
            <div class="card-body">
                <form action="{{ route('editPBL', encrypt($data['trs']['no_pembelian'])) }}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-4">
                            <input type="text" class="form-control" id="harga" name="harga" value="<?= old('harga', $data['trs']['total_harga']) ?>" placeholder="Masukkan harga">
                        </div>
                        ...
                        <div class="col-sm-4">
                            <select class="form-control" name="produk" id="produkSelect">
                                ...
                                <?php foreach ($data['produk'] as $kategori) : ?>
                                    <option value="<?= $kategori['kode_produk'] ?>" <?= $kategori['kode_produk'] == $data['trs']['kode_produk'] ? 'selected' : '' ?>><?= $kategori['merek'] ?></option>
                                <?php endforeach ?>
                            </select>
                        </div>
                    </div>
                    <div class="mb-3 row">
                        ...
                        <div class="col-sm-10">
                            <textarea type="text" class="form-control" id="keterangan" name="keterangan" value="<?= old('keterangan',$data['trs']['keterangan'])?>" placeholder="Masukkan Keterangan Transaksi">{{$data['trs']['keterangan']}}</textarea>
                        </div>
                    </div>
